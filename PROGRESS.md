...
### Latest Updates
  ...
  - 2025-12-16: Sprint04-Task11A4 Task43 cleanup: added temporary cleanup worktree `C:\Repos\SnapCase_App_task43_cleanup` on `task/Sprint03-Task43-edm-live-smoke`, diffed against backup `C:\Repos\SnapCase_App_Backups\Task43_2025-12-16` (`33 files changed, +117/-19187`; backup older/missing Task43 assets/docs) and skipped salvage; stash list stayed empty. Removed dirty OneDrive worktree `C:\Users\ethtr\OneDrive\Documents\Work\SnapCase_App_task43` + metadata, pruned, and dropped the temp worktree so only the primary tree remains. Compare: https://github.com/ethtri/SnapCase_App/compare/main...task/Sprint04-Task11A4-task43-cleanup.
  - 2025-12-16: Sprint04-Task11A3 Task36 cleanup: added temporary non-OneDrive worktree (`task/Sprint03-Task36-printful-order` @ e6f3857) to diff backup `C:\Repos\SnapCase_App_Backups\Task36_2025-12-16` (stat: 184 files changed, +11758/-1847) and skipped salvage; removed OneDrive worktree `C:\Users\ethtr\OneDrive\Documents\Work\SnapCase_App_Task36` (force delete + prune) and dropped the temporary cleanup worktree so the primary repo now has a single attached tree; stash list stayed empty. Compare: https://github.com/ethtri/SnapCase_App/compare/main...task/Sprint04-Task11A3-task36-cleanup.
  - 2025-12-16: Sprint04-Task11A2 hygiene migration: primary worktree now `C:\Repos\SnapCase_App` on `task/Sprint04-Task11A2-hygiene-migration` (OneDrive clone kept for inventory/backups). Recorded OneDrive inventory (worktrees SnapCase_App/SnapCase_App_Task36/SnapCase_App_task43/SnapCase_App_task45; 46 stashes), removed clean `SnapCase_App_task45`, and pruned to three attached worktrees. Backed up dirty Task36/Task43 worktrees and `SnapCase_App_task45_run` clone to `C:\Repos\SnapCase_App_Backups\Task36_2025-12-16`, `...\\Task43_2025-12-16`, `...\\Task45_run_2025-12-16`. Quarantined Cursor docs via stash `Sprint04-Task11A2 cursor-docs`, relocated `repos` to `C:\Repos\SnapCase_App_Backups\cursor-repos-2025-12-16`, and tagged/dropped >48h stashes (`stash-backup-17..45`; remaining dated 12/15-12/16). Compare: https://github.com/ethtri/SnapCase_App/compare/main...task/Sprint04-Task11A2-hygiene-migration.
