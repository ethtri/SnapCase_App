...
- **Sprint03-Task61 picker/detect hotfix (2025-12-15):** Restored device search/typeahead and Apple/Samsung/Google brand chips (Apple glyph) while keeping the compact card layout and variant lock/CTA gating. Added a mobile-only "Detect my phone" helper seeded from UA hints. Tests: `npm run build`. Deployed `https://snapcase-fp908m66x-snapcase.vercel.app` and aliased `dev.snapcase.ai`. Artifacts: `Images/diagnostics/design-before-desktop-2025-12-15T17-12-01.png`, `Images/diagnostics/design-before-mobile-2025-12-15T17-12-01.png`, `Images/diagnostics/design-after-desktop-2025-12-15T17-20-37.png`, `Images/diagnostics/design-after-mobile-2025-12-15T17-20-37.png`.
