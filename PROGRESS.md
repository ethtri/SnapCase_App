...
- **Open issue**: Samsung selections on dev.snapcase.ai still render the iPhone 11 mockup; Printful appears to ignore Samsung identifiers even when locking. To be revisited with live diagnostics and potential vendor escalation.
...
- **Sprint03-Task57 mobile parity (2025-12-11):** Matched the mobile design flow to the restored mockups with compact device chips, trimmed helper/guardrail copy, reduced vertical chrome, and a sticky bottom CTA while keeping Printful variant lock/CTA gating intact. Reduced the EDM frame min-height on small screens to fit the mock. Tests: `npm run build`. Artifacts: `Images/diagnostics/20251211-171021-mobile-before-design.png`/`...-171025-mobile-before-checkout.png`/`...-171028-mobile-before-thankyou.png` and `Images/diagnostics/20251211-172125-mobile-after-design.png`/`...-172131-mobile-after-checkout.png`/`...-172135-mobile-after-thank-you.png`.
