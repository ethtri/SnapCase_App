...
### Latest Updates
  ...
  - 2025-12-18: Sprint04-Task20 rebased onto Task18 (approved picker/shell) and reapplied the simplified summary card (single status chip/helper showing only device/variant, finish, price). Diagnostics: Images/diagnostics/20251218T155914-design-{picker,shell}-{desktop,mobile}.png. Tests: `npm run lint`; `npm run build`. AgentReport: docs/AgentReports/Sprint04-Task20.md. Preview: https://snapcase-pxrwcquta-snapcase.vercel.app. Compare: https://github.com/ethtri/SnapCase_App/compare/main...task/Sprint04-Task20-summary-simplify.
