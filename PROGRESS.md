...
- **2025-12-19: Sprint04-Task22**: Polished `/design` summary card (status chip/helper + device + price; finish row removed) and updated not-ready CTA copy to "Add your design to continue"; picker/shell/CTA gating unchanged. Tests: `npm run lint`, `npm run build`. Diagnostics (preview): `Images/diagnostics/20251219T023220Z-design-{picker,shell}-{desktop,mobile}.png`. Preview: https://snapcase-ikedc1s8f-snapcase.vercel.app. **Dev alias updated** via `vercel alias set https://snapcase-ikedc1s8f-snapcase.vercel.app dev.snapcase.ai --scope snapcase`; rollback: `vercel alias set https://snapcase-hwbcudj5f-snapcase.vercel.app dev.snapcase.ai --scope snapcase`. Verification (dev): `curl -I https://dev.snapcase.ai/design` 200; screenshot `Images/diagnostics/20251219T052059Z-dev-design-shell-desktop.png`. Compare: https://github.com/ethtri/SnapCase_App/compare/task/Sprint04-Task21-summary-hotfix...task/Sprint04-Task22-summary-cta-polish.
...
### Latest Updates
  ...
  - 2025-12-18: Sprint04-Task21 simplified the `/design` summary card to only show the status chip + helper, device/finish, and price while keeping the Task18 picker/shell untouched. Tests: `npm run lint`, `npm run build`. Preview: https://snapcase-pgz7j4zcj-snapcase.vercel.app. Dev alias now points to this deploy for sponsor testing (`vercel alias set ... dev.snapcase.ai --scope snapcase`); rollback target kept: https://snapcase-hwbcudj5f-snapcase.vercel.app. Diagnostics: `Images/diagnostics/20251218T174308-design-{picker,shell}-{desktop,mobile}.png`. Compare: https://github.com/ethtri/SnapCase_App/compare/task/Sprint04-Task18-restore-picker...task/Sprint04-Task21-summary-hotfix.
